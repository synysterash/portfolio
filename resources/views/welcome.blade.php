...
<main id="main">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            <h3>Web Developer</h3>
            <p class="fst-italic">
              A forward-thinking, challenge-driven person that loves to solve problems. By solving problems, I train myself to think critically and
              logically.
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>30 June 2001</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>((pending))</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+6019 494 4096</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>Johor Bahru, Johor</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Age:</strong> <span>21</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Qualification:</strong> <span>Diploma in Technology Management</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <a href="mailto:edrisashman@gmail.com">edrisashman@gmail.com </a></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Freelance:</strong> <span>Available</span></li>
                </ul>
              </div>
            </div>
            <p class="text-center">
              I was a wanderer, moving from Melaka - Shah Alam - Kuala Lumpur - Perlis and now in Johor Bahru. The journey familiarised myself with different cultures
              in different states. Enriched with knowledge and majestic facilities, Universiti Teknologi Malaysia in Johor Bahru became my current destination for me to undertake
    ...
    <section id="resume" class="resume">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Resume</h2>
          <p>A wanderer &amp; explorer have multiple experiences and a colourful background; My experiences are not far within the cusp of a wanderer &amp; and explorer.
              I strive and thrive to expand my skillset and knowledge bank to undertake challenges on challenges so that I can become a better version of myself.</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="resume-item pb-0">
              <h4> Ashman Rahman</h4>
              <p><em> A forward-thinking, challenge-driven person that loves to solve problems. By solving problems, I train myself to think critically and logically.</em></p>
              <ul>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="resume-item">
              ...
              <ul>
                ...
                <li>Maintained the company's network and consulted with Telekom Malaysia for the best network solution.</li>
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <div class="d-flex portfolio-container align-items-stretch" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-6 col-md-6 portfolio-item filter-web ">
            <div class="portfolio-wrap ">
              ...
              <div class="portfolio-links">
                <a href="https://portal.ikan-fresh.com/" target=".blank" title="Website"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-6 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src={{ asset("assets/img/aquadash_text_bold_outline.svg")}} style="background-color: grey" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="https://aquadash.ikan-fresh.com/" target=".blank" title="Website"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p class="text-center">I am a highly skilled and versatile individual, offering a unique combination of talents and expertise that can help you to achieve your goals.</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 icon-box" data-aos="fade-up">
            ...
            <p class="description">Planning, strategizing and coding the website to make it functional and user-friendly.</p>
          </div>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>Do not hesitate to enquire me regarding the services that I offer.</p>
        </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Kolej Perdana, Universiti Teknologi Malaysia, Skudai, 81310 Johor Bahru</p>
              </div>
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d249.27133009098696!2d103.64650381468046!3d1.5590873000000014!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31da71971ea46b5d%3A0x9ef029192f629c64!2sU6%2C%20Surau%20Kolej%20Perdana!5e0!3m2!1sen!2smy!4v1671041776046!5m2!1sen!2smy" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
